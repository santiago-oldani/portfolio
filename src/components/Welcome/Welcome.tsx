...
function Welcome() {
    ...
    return (
        <section className="w-full h-[calc(100vh-200px)] snap-start pt-[100px] pb-[50px] row-start-2 flex flex-col max-[450px]:justify-start max-[450px]:gap-[40px]  justify-between items-center">
