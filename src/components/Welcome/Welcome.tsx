    ...
    return (
        <section className="w-full h-[calc(100vh-200px)] snap-start pt-[100px] pb-[50px] row-start-2 flex flex-col justify-between items-center">
            ...
            <motion.div
                ...
                <h1 className='text-[98px] font-bold m-[0px]'>{welcome.first} </h1>
                <h1 className='text-[#007bff] text-[98px] font-bold m-[0px]'>{welcome.second}</h1>
            </motion.div>
            ...
            <div className="flex flex-row items-center gap-[20px] justify-center">
                ...
                <div className="flex flex-row items-center border-[2px] border-[#007bff] rounded-[8px] overflow-hidden">
                    <a href="/cv-santiago-oldani.pdf" target="_blank" rel="noopener noreferrer" className="px-[20px] py-[10px] text-[#007bff] font-semibold hover:bg-[#f0f7ff] transition">
                        Ver CV
                    </a>
