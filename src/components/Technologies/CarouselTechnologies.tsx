                ...
                {cardsInfo.map((category, key) => {
                    ...
                    return (
                        <SwiperSlide key={key} className="flex justify-center items-center">
                            ...
                            <div className='flex flex-col items-center justify-start border border-solid border-[#e5e5e5] shadow-md rounded-[40px] py-[10px] px-[15px] gap-[15px] w-full bg-white mb-6 min-h-[280px] h-auto'>
