...
const AboutMe: React.FC = () => {
    ...
    return (
        <div className="flex flex-col snap-start py-[125px] max-[1000px]:pt-[80px] max-[1000px]:pb-[80px] px-[20px] items-center justify-center h-full w-full">
            ...
            {isMobile && <div className='flex flex-col items-center justify-center pt-[25px] max-[1000px]:pt-[5px]'>
            ...
            <motion.div
                ...
                <div className='w-[40%] max-[1000px]:p-[0px] max-[1000px]:w-full h-full max-[1000px]:border-none border-r-[1px] border-[#f2f1f5] flex flex-col  items-center justify-start py-[20px] px-[20px] gap-[20px]'>
                    ...
                    <div className='text-[#787a84] font-[600] text-center text-[1rem] border-b-[1px] border-[#f2f1f5] pb-[10px]'>
                    ...
                    <a href="/cv-santiago-oldani.pdf" target="_blank" rel="noopener noreferrer" className="max-[1000px]:border-b-[1px] max-[1000px]:border-[#f2f1f5] px-[20px] py-[10px] text-[#787a84] font-semibold hover:bg-[#f0f7ff] transition">
                        Ver curriculum
                    </a>
                </div>
