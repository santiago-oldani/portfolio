  ...
  return (
    <>
      ...
      <main className="h-screen overflow-y-scroll snap-y snap-mandatory">
        ...
        {!isWelcomeInView ? <CiCircleChevUp size={60} color="#007bff" onClick={() => scrollToSection('welcome')} className="absolute z-50 bottom-10 max-[450px]:bottom-7 max-[450px]:right-7 right-10 cursor-pointer"></CiCircleChevUp> : null}
